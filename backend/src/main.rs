...
async fn main() {
    ...
    let hsts_state = crate::middleware::crate::middleware::crate::middleware::HstsState(server_config.clone());
    let title_state = shared_backend::middleware::crate::middleware::TitleState(server_config.clone());
